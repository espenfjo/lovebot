...
public class TvScheduleUsa implements ModIface,Runnable{
static	Server server;
	static Channel channel;
	String name = "TvScheduleUsa";
	String trigger = "!tv";
	Thread TV;
	...
	public void startPlug(String inputLine, Server server, Channel channel) {
		...
		TV = new Thread(new TvScheduleUsa());
		TV.start();
	}

	public void run() {
		String finalShow = "";
		String url = "http://www.tvrage.com/myrss.php?tid=9629&hash=97397894944d12293c8a833af3bb37da";
		try {
			...
			Actions.say("I natt kommer følgende: " + finalShow, channel, server);
		} catch (Exception e) {
