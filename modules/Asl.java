...
public class Asl implements ModIface{
	public String trigger = "asl?";
	String name = "Asl";
	public void startPlug(String inputLine,Server server, Channel channel){
		Random randomGen = new Random();
		String[] asl = {"14 tjollololo sjarlottlauk","14 bærte bærum", "57 gutt brønnøysund", "21 gutt 25-14", "23 usikker steinan", "20 jente 25-14", "22 jente halden", "35 mann Trondheim", "16 jente risvollan", "16 jente nardo", "1 Fride 25-14"};
